   ...
   */
   ...
   UFUNCTION( BlueprintCallable, Category = "Agora|VideoManager" )
	...
	/** Sets the bool value of a specified key in the JSON format.
	  ...
	  @param Bool Sets the value.
	  @return
	  - 0: Success.
	  - < 0: Failure.
	  */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int SetBool( const FString& Key, bool Bool );

	/** Sets the int value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Int Sets the value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int SetUInt( const FString& Key, int64 UInt );

	/** Sets the double value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Number Sets the value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int SetNumber( const FString& Key, float Number );

	/** Sets the string value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param String Pointer to the set value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int SetString( const FString& Key, const FString& String );

	/** Sets the object value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Object Pointer to the set value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int SetObject( const FString& Key, const FString& Object );

	/** Retrieves the bool value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Bool Pointer to the retrieved value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetBool( const FString& Key, bool& Bool );

	/** Retrieves the int value of the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Int Pointer to the retrieved value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetInt( const FString& Key, int& Int );

	/** Retrieves the unsigned int value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param UInt Pointer to the retrieved value.
	 @return
	 - 0: Success.
	 - < 0: Failure.
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetUInt( const FString& Key, int64& UInt );

	/** Retrieves the double value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Number Pointer to the retrieved value.
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetNumber( const FString& Key, float& Number );

	/** Retrieves the string value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param String Pointer to the retrieved value.
	...
	*/
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetString( const FString& Key, FString& String );

	/** Retrieves a child object value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Object Pointer to the retrieved value.
	 @return
	 - 0: Success.
	 - < 0: Failure.
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetObject( const FString& Key, FString& Object );

	/** Retrieves the array value of a specified key in the JSON format.

	 @param Key Pointer to the name of the key.
	 @param Array Pointer to the retrieved value.
	 @return
	 - 0: Success.
	 - < 0: Failure.
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int GetArray( const FString& Key, FString& Array );
	 ...
	 */
	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int SetProfile( const FString& Profile, bool Merge );

	UFUNCTION( BlueprintCallable, Category = "Agora|Parameters" )
		int ConvertPath( const FString& FilePath, FString& ConvertedPath );
